...
#dyn-leaderboard-theme .lb-gem { width: 1.7cqh; height: 1.7cqh; flex: 0 0 auto; }
...
#dyn-leaderboard-theme[data-theme="podium"] .lb-gem { display: none; }
...
#dyn-leaderboard-theme[data-theme="compact-ladder"] .lb-gem { display: none; }
...
/* ── Gold spotlight ── */
#dyn-leaderboard-theme[data-theme="hero-list"] .lb-body { gap: 2cqh; width: min(82cqw, 100%); }
...
#dyn-leaderboard-theme[data-theme="hero-list"] .lb-hero-ribbon {
  font-size: 1.7cqh;
  font-weight: 800;
...
#dyn-leaderboard-theme[data-theme="hero-list"] .lb-hero .lb-wreath-wrap { width: 10cqh; height: 7.2cqh; }
#dyn-leaderboard-theme[data-theme="hero-list"] .lb-hero .lb-trophy { width: 3.4cqh; height: 3.4cqh; }
#dyn-leaderboard-theme[data-theme="hero-list"] .lb-hero .lb-name { font-size: 3.4cqh; color: var(--primary, #f5c542); }
#dyn-leaderboard-theme[data-theme="hero-list"] .lb-hero .lb-score { font-size: 3.1cqh; color: var(--primary, #f5c542); justify-content: center; }
...
`;
  ...
  function scoreHtml(leader, pill) {
    const inner = markImg("lb-gem", "lb-diamond") + esc(leader.score || "");
    return pill
  ...
  function fillHero(themeRoot, capture, settings) {
    ...
    if (hero && heroEl) {
      heroEl.innerHTML =
        '<div class="lb-hero-ribbon">Leaderboard</div>' +
